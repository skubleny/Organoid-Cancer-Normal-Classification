...
#Save svg (Note: the gene expression legend appears different in viewer compared to saved file)
svg(filename="heatmap_ffpe_organoid_new_small.svg", width=12.2, height=4.5)
draw(heatmap)
draw(lgd, x = unit(30.8, "cm"), y = unit(5, "cm"), just = c("right", "bottom"))
dev.off()
#Save png
png(filename="heatmap_ffpe_organoid_new_small.png", width=12.2, height=4.5,units="in", res = 300)
draw(heatmap)
draw(lgd, x = unit(27.9, "cm"), y = unit(1, "cm"), just = c("right", "bottom"))
dev.off()
